...
(function() {
	...
	(function() {
		...
		div.innerHTML = [
		/*遮罩*/
		"<meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\" /><div id='maskLevel' style=\'" + maskStyle + ';z-index:10000;\'></div>', IE6 ? ("<iframe id='maskIframe' src='javascript:false' style='" + maskStyle + ";z-index:9999;filter:alpha(opacity=0);opacity:0'></iframe>") : '',
		/*窗体*/
